...
//    | TableDrawContextMenu()                  - draw right-click context drawMenu
//-----------------------------------------------------------------------------
// - TableHeadersRow() or TableHeader()         user submit a headers row (optional)
//    | TableSortSpecsClickColumn()             - when left-clicked: alter sort order and sort direction
//    | TableOpenContextMenu()                  - when right-clicked: trigger opening of the default context drawMenu
...
// - Case C: column is hidden explicitly by the user (e.g. via the context drawMenu, or _DefaultHide column flag, etc.).
//
//                        [A]         [B]          [C]
...
void ImGui::TableUpdateLayout(ImGuiTable* table)
{
    ...
    // because of using _WidthAuto/_WidthStretch). This will hide the resizing option from the context drawMenu.
...
void    ImGui::EndTable()
{
    ...
    // Context drawMenu in columns body
...
void ImGui::TableHeader(const char* label)
{
    ...
    // Keep header highlighted when context drawMenu is open.
...
// Use -1 to open drawMenu not specific to a given column.
...
// Output context drawMenu into current window (generally a popup)
